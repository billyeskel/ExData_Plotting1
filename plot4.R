...
## top right 
with(raw2, plot(datetime, Voltage, type = 'l', xlab = "datetime",
                ylab = "Voltage"))

## bottom left
with(raw2, plot(datetime, Sub_metering_1, type = 'l', xlab = "", col = "black",
                ylab = "Energy sub metering"))
lines(raw2$datetime, raw2$Sub_metering_2, col = "red")
lines(raw2$datetime, raw2$Sub_metering_3, col = "blue")

## bottom right 
with(raw2, plot(datetime, Global_reactive_power, type = 'l', xlab = "datetime"))

## legend (for bottom left chart)
# legend(0.5, 0.5, col = c("black", "red", "blue"), 
